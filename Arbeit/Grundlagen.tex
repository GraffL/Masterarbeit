...
\begin{defn}\todo{Schritt/Verbesserungsschritt/... definieren?}
...
\begin{beob}\label{beob:BASchritteNG}
	Eine Strategieprofil $x \in X$ ist genau dann ein Nash-Gleichgewicht, wenn $(x,x)$ für jeden Spieler ein Beste-Antwort-Schritt ist.\todo{Genauer ausführen/beweisen?}
\end{beob}
