...
\begin{defn}\defIndexSil{Spiel}
	...
	Wir nennen ein solches Spiel \defIndexSub{endlich}{Spiel}{endliches}, wenn der gesamte Strategieraum $X$ endlich ist, und \defIndexSub{$N$-Personen-}{Spiel}{$N$-Personen-}, wenn $\abs{I} = N \in \IN$ gilt.
\end{defn}
