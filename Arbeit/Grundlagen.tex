...
\begin{kor}\label{kor:ExVerbPfadExNG}\todo{Sollte eine Beobachtung wirklich ein Korrolar haben? Auch für Beste-Antwort-Pfade formulieren?}
...
Eine wichtige Eigenschaft, welche alle Matroide erfüllen, ist der starke Basisaustauschsatz (vgl. \cite{OptiIVSkript}[Satz 3.7]):
