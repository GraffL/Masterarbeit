...
\begin{beob}\label{beob:VerbPfadeundNGe}
	...
	Umgekehrt ist offenkundig auch jedes Nash-Gleichgewicht Ende wenigstens eines maximalen Verbesserungspfades - nämlich des trivialen, nur aus diesem Strategieprofil bestehenden Verbesserungspfades\todo{damit das stimmt, darf sich das \glqq maximaler\grqq{} nur auf Verlängerung nach hinten beziehen (nicht auf Verlängerung nach vorne)}.
\end{beob}
