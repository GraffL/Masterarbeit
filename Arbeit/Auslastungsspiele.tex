...
\begin{figure}[h]\centering
	...
	\Crefformat{satz}{\thb{#2Satz #1#3}}\Crefformat{lemma}{\thb{#2Lemma #1#3}}\Crefformat{bem}{\thb{#2Bem. #1#3}}\Crefformat{bsp}{\thb{#2Bs\smash{p}. #1#3}}
	\hypersetup{hidelinks}	
	\resizebox{.99\textwidth}{!}{\input{../Bilder/EulerDiagramm2.pdf_tex}}
	% Standarddefinitionen von Cref-Format wiederherstellen:
	\Crefformat{satz}{Satz #2#1#3}\Crefformat{lemma}{Lemma #2#1#3}\Crefformat{bem}{Bemerkung #2#1#3}\Crefformat{bsp}{Beispiel #2#1#3}
