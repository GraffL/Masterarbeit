...
In \Cref{abb:Zusammenfassung} sind die meisten der in diesem Kapitel beschriebenen Zusammenhänge in einer gemeinsamen Übersicht dargestellt.\todo{Evtl. Beispiele für nicht-Inklusionen mit darstellen?}
...
\begin{figure}[h]\centering
	...
	\caption{Eingige Zusammenhänge zwischen den verschiedenen Spieleklassen. Die Inklusionen gelten jeweils für beliebige Spiele.}
