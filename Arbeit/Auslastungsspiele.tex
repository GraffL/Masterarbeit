...
\begin{satz}
	Sei $\Gamma(M)$ ein Auslastungsspiel, wobei jeder Strategieraum Basis eines Matroids ist. Dann besitzt $\Gamma(M)$ ein Beste-Antwort-Potential dessen Bild höchstens $\abs{I}^2\abs{R}^2$ verschiedene Werte umfasst.\todo{Kann man aus Satz 3.10 aus dem Opti IV-Skript eine Aussage dieser oder ähnlicher Form extrahieren? Evtl. noch passende Morphismen zwischenschalten...}
\end{satz}
