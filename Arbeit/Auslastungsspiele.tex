...
\todo[inline]{Verallgemeinerung für unendliche Spiele? Evtl. an passenderer Stelle einfügen.}
...
Da wir dies mit Hilfe von \Cref{satz:CharExPot} bzw. \Cref{satz:CharGewPot} tun wollen, betrachten wir zunächst einen beliebigen (nicht-trivialen) $4$-Zykel $\gamma = (s, (s\mid t_i), (s \mid t_i \mid t_{i'}), (s \mid t_{i'}), s)$. Das folgende Lemma zeigt, wie wir die (gewichtete) Gesamtänderung entlang eines solchen Zykels berechnen können:
...
\begin{kor}
	\todo[inline]{Verallgemeinerung von \Cref{satz:MondererShapleyKostengew}}
\end{kor}
