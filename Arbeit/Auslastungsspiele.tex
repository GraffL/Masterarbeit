...
Für endliche Spiele erhalten wir aus \Cref{satz:JedesSpielLastGewAusl} und \Cref{kor:JedesSpielGewAusl} zusammen noch eine Version von \Cref{lemma:lastgewAuslIsomGewAusl} mit einem stärkeren Isomorphiebegriff:
...
\begin{satz}\label{satz:ExUndGewPotAlsAnonymeAusl}
...
\begin{proof}
	Wir verwenden eine leicht angepasste Variante der Konstruktion aus dem Beweis zu \Cref{satz:MondererShapley}: Gegeben also ein Spiel $\Gamma = (I, X, (c_i))$ mit einem exakten Potential $P$. Hierzu definieren wir folgendes nicht-anonymes Auslastungsmodell $M = (I, R, S, (g_r)_{r \in R})$:
	\begin{itemize}
	...
	\end{align*}
	Für den Beweis des zweiten Teils des Satzes können wir völlig analog den Beweis zu \Cref{satz:MondererShapleyKostengew} anpassen.
\end{proof}
