...
\begin{bsp}
	...
	\todo[inline]{Das funktioniert nicht (wäre nur Kostenerhaltend für Spieler $\hat{i}$) Evtl. anderen Morphismentyp (und/oder andere Richtung!) Probieren. Order einfach weglassen.}
\end{bsp}
