...
\begin{prop}\label{prop:NGerhalten}\todo{Satz muss deutlich angepasst werden. Ist der Satz überhaupt in dieser Allgemeinheit zu retten?}
...
\begin{proof}
	Sei $(\tau, \psi): \Delta \to \Gamma$ ein Rechtsinverses von $(\sigma, \phi)$, d.h. es gelte $(\sigma, \phi) \circ (\tau, \psi) = (\tau\circ\sigma, \phi\circ\psi) = (\id_J, id_Y)$. Damit ist $\sigma$ offenbar injektiv\todo{Benötigen aber bijektiv!}{} und daher mit \Cref{kor:ReflektNG} die \glqq wenn\grqq-Richtung gezeigt.
	...
	und daher wegen Biordinalität\todo{Das stimmt so nicht!}{} von $\phi$ auch 
