...
\begin{beob}\label{beob:InverseVonSkalMorphSindOrd}
	Das Inverse eines Isomorphismus, welcher zudem ein skalierter Morphismus ist, ist also nicht zwangsläufig selbst wieder skaliert. Zumindest ist das Inverse aber noch ordinal, also ein ordinaler Isomorphismus.\todo{Beweis?}
\end{beob}
