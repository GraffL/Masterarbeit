...
Wie wir gesehen haben hängen die verschiedenen Morphismen (und insbesondere Isomorphismen) eng mit den entsprechenden Potentialen zusammen. In diesem Kapitel werden wir dies ausnutzen um mit Hilfe entsprechender Eigenschaften der Morphismen einige Sätze aus \Cref{sec:Potentiale} zu zeigen.
...
\begin{prop}
	...
	\begin{center}
		...
		\end{tikzpicture}
	\end{center}
\end{prop}\todo{Wie sieht es mit Isomorphismen aus? Speziell auf Zusammenhang von skaliert und monoton eingehen!}
...
Ordinale Morphismen mit surjektiver Spielerabbildung erhalten also Verbesserungspfade und reflektieren Nicht-Verschlechterungspfade.
...
Dies zeigt also nochmal, dass ordinale Potentiale lokale Nash-Potentiale sind.

\todo[inline]{Jetzt noch für Beste-Antwort-Potentiale}
