...
\begin{bsp}
	Wir definieren die folgenden drei Spiele:\todo{Korrektheit des Beispiels prüfen!}
	\begin{center}
		$\Gamma:$ \quad
		\begin{tabular}{c||c|c}
				& l 		& r 		\\\hline\hline
	...
	\begin{itemize}
		...
		\item Der Morphismus $(\tau, \psi): \Delta \to \Epsilon$ mit $\tau(1) = \tau(2) = 1$ und $\psi_1(a) = l, \psi_1(b) = r, \psi_2(a) = t, \psi_2(b) = r$ ist ein ordinaler Morphismus, dessen Spielerabbildung nicht injektiv ist. Und in der Tat gilt auch hier die Aussage des Korollars nicht: Denn $a$ ist kein Nash-Gleichgewicht von $\Delta$, obwohl $\psi(a) = (t,l)$ ein Nash-Gleichgewicht von $\Epsilon$ ist.
	\end{itemize}
\end{bsp}
