...
\begin{figure}[h]\centering
	\includegraphics[width=.5\textwidth]{../Bilder/EulerDiagPotentiale.pdf}
...
Die Zusammenhänge lassen sich alle leicht direkt beweisen. Wir werden diese Beweise hier allerdings nicht führen, da sich die Aussagen auch aus den allgemeineren Sätzen über die entsprechenden Morphismen ergeben, die wir in \Cref{sec:Morphismen} definieren werden (die Beweise finden sich dann in \Cref{sec:Morphismen:Potentialsaetze}). In \cite[Beispiele 4.1, 4.2 und 4.3]{BestRespPot} liefert \citeauthor{BestRespPot} auch Beispiele für die Echtheit der Inklusionsbeziehungen zwischen allen dort definierten Potentiale.\todo{Beispiele für die Echtheit der Inklusion der anderen Beziehungen angeben?}
